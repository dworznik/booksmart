# Semantic search over the embedded vectors — findings
...
>
> **Frozen** (2026-07-10), when this research merged with its implementation.
...
> so the query vector is `embedder.embed([query]).vectors[0]`.
