...
> Fixture eval answering the question the hybrid-search work could
...
>
> **Frozen** (2026-08-03), when this eval merged with the hybrid slices it
...
1. **Reconsider hybrid-by-default** (it shipped as the default on the
