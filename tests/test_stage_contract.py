...
from app.models import Chapter, KnowledgeObject, Run
from app.parsing import build_default_chain
from app.runner import SCOPE_STAGES, execute_run, start_run
...
class TestPerStageSessionContract:
    def test_fresh_session_per_stage_produces_a_complete_ingest(
        ...
        book_id = uuid.UUID(register_book_with_hints(client))
...
class TestErrorTaxonomy:
    def test_retriable_flags_are_class_level(self) -> None:
        ...
        from app.summaries import SummaryError
